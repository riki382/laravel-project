                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" method="post" data-parsley-validate=""
                                  ...
                                  action="{{ route('slider.update', $row->id) }}" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Status <span
                                                class="required">*</span>
                                    </label>
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Caption <span
                                                class="required">*</span>
                                    </label>
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                        <textarea id="caption" name="caption" required="required" class="form-control col-md-7 col-xs-12">{{ $row->caption }}</textarea>
                                    </div>
                                </div>
