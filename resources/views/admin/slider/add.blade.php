        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form id="demo-form2" data-parsley-validate="" method="post" class="form-horizontal form-label-left" action="{{route('slider.store')}}" novalidate="" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12">
                                    <textarea id="caption" name="caption" required="required" class="form-control col-md-7 col-xs-12" type="text"></textarea>
                                </div>
                            </div>
