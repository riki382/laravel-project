						...
						<form id="demo-form2" data-parsley-validate="" method="post" class="form-horizontal form-label-left"
							...
							<div class="form-group">
								...
								<div class="col-md-10 col-sm-6 col-xs-12">
									<input id="title" name="title"  class="form-control col-md-7 col-xs-12" type="text">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-10 col-sm-6 col-xs-12">
									<input id="title" name="price"  class="form-control col-md-7 col-xs-12" type="text">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-10 col-sm-6 col-xs-12">
									<textarea id="content" name="content" class="form-control col-md-7 col-xs-12" type="text">
									</textarea>
								</div>
							</div>
