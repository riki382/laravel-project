                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate="" method="post" class="form-horizontal form-label-left" action="{{route('featured.store')}}" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-3 col-xs-12">Category <span class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-3 col-xs-12">Product <span class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-12" id="productoption">
