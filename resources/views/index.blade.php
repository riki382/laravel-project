								...
								<div class="product-image-wrapper">
									<div class="single-products">
											<div class="productinfo text-center">
												<img height="200" src="{{ $feature->image }}" alt="" />
												<h2>{{ $feature->discount }}</h2>
												<p>{{ $feature->title }}</p>
												<a href="/cart/add/{{$feature->product_id}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
									</div>
									<div class="choose">
							...
							<div class="tab-pane fade active in" id="tshirt" >
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img height="130" src="{{ $product->image }}" alt="" />
												<h2>{{ $product->price }}</h2>
												<p>{{ $product->title }}</p>
